...
def cyclic_learning_rate(global_step,
  ...
  with ops.name_scope(name, "CyclicLearningRate",
                      [learning_rate_min, global_step]) as name:
    learning_rate_min = ops.convert_to_tensor(learning_rate_min, name="learning_rate")
    dtype = learning_rate_min.dtype
    ...
    def cyclic_lr():
      ...
      # computing: clr = learning_rate_min + ( max_lr – learning_rate_min ) * max( 0, 1 - x )
      a1 = math_ops.maximum(0., math_ops.subtract(1., x))
      a2 = math_ops.subtract(max_lr, learning_rate_min)
      ...
      return math_ops.add(clr, learning_rate_min, name=name)
