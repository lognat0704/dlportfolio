...
parser.add_argument('--model_url', default='/home/nelson/pretrained_models/karras2019stylegan-ffhq-1024x1024.pkl', help='Fetch a StyleGAN model to train on from this URL')
parser.add_argument('--model_res', default=1024, help='The dimension of images in the StyleGAN model', type=int)
parser.add_argument('--data_dir', default='data', help='Directory for storing the EfficientNet model')
parser.add_argument('--model_path', default='data/finetuned_effnet_18.h5', help='Save / load / create the EfficientNet model with this file path')
parser.add_argument('--model_depth', default=2, help='Number of TreeConnect layers to add after EfficientNet', type=int)
parser.add_argument('--model_size', default=3, help='Model size - 0 - small, 1 - medium, 2 - large, or 3 - full size.', type=int)
